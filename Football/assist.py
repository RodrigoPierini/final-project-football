...
data_fw_ml = data_fw[['Player', 'Nation', 'Squad', 'Comp', 'Age', 'Minutes_Played', 'GoalCreatingAction', 'Assists', 'Key_Passes']]
...
X = data_fw_ml.drop(columns=['Player', 'Assists'])
y = data_fw_ml['Assists']
...
# Save the model
pickle.dump(model, open("assist_model.pkl", "wb"))

# Save the scaler
pickle.dump(scaler, open("assist_scaler.pkl", "wb"))