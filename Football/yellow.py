...
data_fw_ml = data_fw[['Player', 'Nation', 'Squad', 'Comp', 'Age', 'Minutes_Played', 'CrdY', '2CrdY', 'Fouls_Comitted', 'Tackles']]
...
X = data_fw_ml.drop(columns=['Player', 'CrdY', '2CrdY'])
y = data_fw_ml['CrdY']
...
# Print the best parameters and train the final model
